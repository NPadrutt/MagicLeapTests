...
namespace MagicKit
{
    ...
    public class GestureManager : Singleton<GestureManager>
    {
        ...
        private void Update()
        {
            ...
            if (_leftActive && (!_leftRecognized || MLHands.Left.KeyPoseConfidence < _stopConfidence || MLHands.Left.KeyPose != _lastLeftKeyPose))
            {
                _leftActive = false;
            ...
            if (_rightActive && (!_rightRecognized || MLHands.Right.KeyPoseConfidence < _stopConfidence || MLHands.Right.KeyPose != _lastRightKeyPose))
            {
                _rightActive = false;
                if (OnGestureEnd != null)
                {
